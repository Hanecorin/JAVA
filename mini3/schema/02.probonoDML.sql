...
insert into probono_project (probono_project_name, probono_id, activist_id, recipient_id, project_content) values('슈바이처 프로젝트', 'schweitzer', 'giver1', 'receivePeople1', '아토피 무상 치료');
insert into probono_project (probono_project_name, probono_id, activist_id, recipient_id, project_content) values('오드리햅번 프로젝트', 'audreyHepbun', 'giver2', 'receivePeople2', '무료컷팅');
insert into probono_project (probono_project_name, probono_id, activist_id, recipient_id, project_content) values('키다리아저씨 프로젝트', 'schweitzer', 'giver3', 'receivePeople3', '장학금지원');
